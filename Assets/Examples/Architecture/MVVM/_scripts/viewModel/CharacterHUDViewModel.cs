...
namespace DenisKim.MVVM.Education.ViewModel // Пространство имен для ваших ViewModel
{
    public class CharacterHUDViewModel : IDisposable // Класс ViewModel, реализующий IDisposable для корректной очистки ресурсов
    {
        ...
        // Публичное ReadOnlyReactiveProperty для доступа к текущему здоровью из хендлера (Модели)
